...
output:
  ...
  html_document:
    toc: true
vignette: >
  %\VignetteIndexEntry{Getting Started with NestNetR}
...
The package requires _devtools_ (install if necessary using the _install.packages()_ function). With _devtools_ on your system, you are able to download and built as well as install R packages directly from GitHub (e.g. _NestNetR_).
