...
author: "BP Stolze, M. Klaassen, S. Lisovski"
date: "`r Sys.Date()`"
output:
  pdf_document: 
    toc: true
...
```{r, eval = FALSE}
breeding_data_list <- create_breeding_data_list(dir.raw, auto = TRUE, segment_days = 1)
...
for (ID in names(breeding_data_list)) {
  ...
  # Store in list
  classified_breeding[[ID]] <- classify_breeding_behaviour(breeding_data_list[[ID]])
}
